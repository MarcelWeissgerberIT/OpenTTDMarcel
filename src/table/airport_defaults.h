...
/* Fork: Kacheln des Mega-Flughafens. */
static const std::initializer_list<AirportTileTable> _tile_table_mega_0 = {
	MK(0, 0, APT_RUNWAY_END_FENCE_NE_NW),
	MK(1, 0, APT_RUNWAY_FENCE_NW),
	MK(2, 0, APT_RUNWAY_FENCE_NW),
	MK(3, 0, APT_RUNWAY_FENCE_NW),
	MK(4, 0, APT_RUNWAY_FENCE_NW),
	...
	MK(6, 0, APT_RUNWAY_FENCE_NW),
	MK(7, 0, APT_RUNWAY_FENCE_NW),
	MK(8, 0, APT_RUNWAY_FENCE_NW),
	MK(9, 0, APT_RUNWAY_FENCE_NW),
	MK(10, 0, APT_RUNWAY_FENCE_NW),
	MK(11, 0, APT_RUNWAY_END_FENCE_NE_NW),
	MK(0, 1, APT_RUNWAY_2),
	MK(1, 1, APT_RUNWAY_2),
	MK(2, 1, APT_RUNWAY_2),
	MK(3, 1, APT_RUNWAY_2),
	...
	MK(8, 1, APT_RUNWAY_2),
	MK(9, 1, APT_RUNWAY_2),
	MK(10, 1, APT_RUNWAY_2),
	MK(11, 1, APT_RUNWAY_2),
	MK(0, 2, APT_APRON),
	MK(1, 2, APT_APRON),
	MK(2, 2, APT_STAND),
	MK(3, 2, APT_STAND),
	...
	MK(0, 6, APT_APRON),
	MK(1, 6, APT_APRON),
	MK(2, 6, APT_HELIPAD_2),
	MK(3, 6, APT_HELIPAD_2),
	MK(4, 6, APT_TOWER),
	MK(5, 6, APT_BUILDING_2),
	MK(6, 6, APT_APRON),
	MK(7, 6, APT_BUILDING_3),
	MK(8, 6, APT_RADAR_GRASS_FENCE_SW),
	MK(9, 6, APT_BUILDING_1),
	MK(10, 6, APT_RADIO_TOWER_FENCE_NE),
	MK(11, 6, APT_DEPOT_SE),
	MK(0, 7, APT_APRON),
	MK(1, 7, APT_APRON),
	MK(2, 7, APT_APRON),
	MK(3, 7, APT_APRON),
	...
	MK(8, 8, APT_RUNWAY_2),
	MK(9, 8, APT_RUNWAY_2),
	MK(10, 8, APT_RUNWAY_2),
	MK(11, 8, APT_RUNWAY_2),
	MK(0, 9, APT_RUNWAY_END_FENCE_SE_SW),
	MK(1, 9, APT_RUNWAY_FENCE_NW),
	MK(2, 9, APT_RUNWAY_FENCE_NW),
	MK(3, 9, APT_RUNWAY_FENCE_NW),
	MK(4, 9, APT_RUNWAY_FENCE_NW),
	MK(5, 9, APT_RUNWAY_FENCE_NW),
	MK(6, 9, APT_RUNWAY_FENCE_NW),
	MK(7, 9, APT_RUNWAY_FENCE_NW),
	MK(8, 9, APT_RUNWAY_FENCE_NW),
	MK(9, 9, APT_RUNWAY_FENCE_NW),
	MK(10, 9, APT_RUNWAY_FENCE_NW),
...
static const std::initializer_list<AirportTileLayout> _tile_table_mega = {
	{ _tile_table_mega_0, Direction::N },
};
...
extern const AirportSpec _origin_airport_specs[] = {
	...
	/* Fork: der Mega-Flughafen - 16 Terminals, zwei Bahnen, ab 2020. */
	AS(mega,             12, 11, 2020, CalendarTime::MAX_YEAR, 12, 30, 90, ATP_TTDP_LARGE,    APC_HUB,      STR_AIRPORT_MEGA,             SPR_AIRPORT_PREVIEW_INTERCONTINENTAL),
};
